export default {
  ...
  // Select
  select: {
    base: 'block w-full text-sm dark:text-gray-300 rounded-lg focus:outline-none',
  ...
  // Label
  label: {
    base: 'block text-sm text-gray-700 dark:text-gray-300',
  ...
  // Input
  input: {
    base: 'block w-full text-sm rounded-lg focus:outline-none dark:text-gray-300 form-input leading-5',
    ...
    disabled: 'cursor-not-allowed opacity-60 bg-gray-300 dark:bg-gray-800',
    valid: 'border-green-600 dark:bg-gray-700 focus:border-green-400 dark:focus:border-green-400 focus:shadow-outline-green dark:focus:shadow-outline-green',
    invalid: 'border-red-600 dark:bg-gray-700 focus:border-red-400 dark:focus:border-red-400 focus:shadow-outline-red dark:focus:shadow-outline-red',
