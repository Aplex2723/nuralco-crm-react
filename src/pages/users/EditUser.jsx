    ...
    <>
      ...
      <div className='grid grid-cols-1 lg:grid-cols-2 gap-4 '>
        {users.map(user => (
          ...
          <div className="px-5 py-5 mb-8 grid grid-cols-1 md:grid-cols-2 gap-4 bg-white rounded-lg shadow-md dark:bg-gray-800">
            <div className=' '>
              ...
              <Label className='truncate mb-1'>{user.user_details.email}</Label> 
              <div className='grid grid-cols-2 gap-5'>
                <Badge type={user.is_active ? `success` : "danger"}>{user.is_active ? "Activo" : "Inactivo"}</Badge>
            ...
            <div>
              ...
              <h1 className='text-black flex flex-col items-center justify-center dark:text-white font-bold'>Fecha de registro</h1>
              <Label>{user.date_of_joining || '--'}</Label>
              {user.phone && (
                <div>
                  <h1 className='text-black flex mt-2 flex-col items-center justify-center dark:text-white font-bold'>Número</h1>
                  <Label>{user.phone}</Label>
                </div>
              )}
              <h1 className='text-black flex mt-2 flex-col items-center justify-center dark:text-white font-bold'>Correo Alternativo</h1>
              <Label className='truncate'>{user.user_details.alternate_email || '--'}</Label>
              <h1 className='text-black flex mt-2 flex-col items-center justify-center dark:text-white font-bold'>Descripcción</h1>
